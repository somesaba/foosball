...
public class Foosball {
	...
	public static void main(String[] args) {
		...
		GameStateUpdater gameStateUpdater = new GameStateUpdaterImpl();
		...
		for(int i = 0; i < 4; i++) {
			...
			rowToPlayerDistanceMap.put(i, 75);
			rowToXPositionMap.put(i, i*76 + 40);
		}
	...
	public void setRowToPlayerDistanceMap(
			Map<Integer, Integer> rowToPlayerDistanceMap) {
